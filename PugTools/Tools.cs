...
namespace tor_tools
{
    public partial class Tools : Form
    {
        ...
        private void SmartLink(DataObjectModel dom)
        {
            ...
            addtolist2("Cross-linking achievements...");//Load ach
            ...
            addtolist2("Cross-linking ability packages (NPCs)...");//Load apns
            ...
            addtolist2("Cross-linking codex entries...");//Load codex entries
            ...
            addtolist2("Cross-linking classes...");//Load classes
            ...
            addtolist2("Cross-linking decorations...");//Load decorations
            ...
            addtolist2("Cross-linking dynamic placeables...");//Load dyn
            ...
            addtolist2("Cross-linking encounters...");//Load enc
            ...
            addtolist2("Cross-linking items...");//Load items
            ...
            addtolist2("Cross-linking NPCs...");//Load NPCs
            ...
            addtolist2("Cross-linking phases...");//Load phases
            ...
            addtolist2("Cross-linking placeables...");//Load placeables
            ...
            addtolist2("Cross-linking schematics...");//Load schematics
            ...
            addtolist2("Cross-linking spawners...");//Load spawners
