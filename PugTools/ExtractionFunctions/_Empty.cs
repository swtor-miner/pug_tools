...
namespace tor_tools
{
    public partial class Tools
    {
        ...
        private void EmptyFromPrototypeAsTxt(List<object> _)
        {
            //double i = 0;
            //double e = 0;
        ...
        private XElement EmptyFromPrototypeAsXElement(List<object> rankProto, bool _)
        {
            if (rankProto is null)
            {
                throw new ArgumentNullException(nameof(rankProto));
            }
        ...
        private void EmptyFromPrototypeAsJSON(ref List<object> _)
        {
            //double i = 0;
            //string n = Environment.NewLine;
