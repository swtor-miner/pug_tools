    ...
    public partial class WorldBrowser : Form
    {
        ...
        private async void TreeViewFast1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            else if (tag.dynObject != null)
            {
                ...
                if (tag.dynObject is HashFileInfo info)
                {
        ...
        private void PreviewNPC_GR2(NpcAppearance npcData)
        {
            if (InvokeRequired)
            {
        ...
        private void PreviewIPP_GR2(ItemAppearance itemData)
        {
            if (InvokeRequired)
            {
        ...
        private void PreviewMultipleIPPs_GR2(List<ItemAppearance> itemsData)
        {
            if (InvokeRequired)
            {
        ...
        private void PreviewITM_GR2(GomObject obj, GomObjectData itemData)
        {
            if (InvokeRequired)
            {
        ...
        private void PreviewDYN_GR2(GomObject obj, List<object> visualList)
        {
            if (InvokeRequired)
            {
        ...
        private void PreviewGR2(HashFileInfo info)
        {
            if (InvokeRequired)
            {
