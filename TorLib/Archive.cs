...
namespace TorLib
{
    ...
    {
        private readonly Dictionary<ulong, FileInfo> fileLookup = new Dictionary<ulong, FileInfo>();
        public List<File> files = new List<File>();
        //public HashSet<string> directories = new HashSet<string>();

        internal Library Library { get; set; }
        public string FileName { get; set; }
        internal string StrippedFileName_ { get; set; }
        ...
        public string StrippedFileName
        {
            get
            {
                if (StrippedFileName_ == null && FileName != null)
                {
