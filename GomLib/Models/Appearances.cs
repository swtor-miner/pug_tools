...
namespace GomLib.Models
{
    public class AppSlot : PseudoGameObject, IEquatable<AppSlot>
    {
        ...
        public AMIEntry AMI
        {
            ...
            {
                if (_AMI == null)
                    _AMI = Dom_.ami.Find(Type, ModelID);
                return _AMI;
            }
        }
        ...
        private AMIEntry PrimaryAMI
        {
            ...
            {
                if (_PrimaryAMI == null)
                    _PrimaryAMI = Dom_.ami.Find("garmenthue", PrimaryHueId);
                return _PrimaryAMI;
            }
        }
        [Newtonsoft.Json.JsonIgnore]
        ...
        private AMIEntry SecondaryAMI
        {
            get
            {
                if (_SecondaryAMI == null)
                    _SecondaryAMI = Dom_.ami.Find("garmenthue", SecondaryHueId);
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is AppSlot aps)) return false;
    ...
    public class ItemAppearance : GameObject, IEquatable<ItemAppearance>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is ItemAppearance ipp)) return false;
    ...
    public class NpcAppearance : GameObject, IEquatable<NpcAppearance>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is NpcAppearance npp)) return false;
    ...
    public class WeaponAppearance : PseudoGameObject, IEquatable<WeaponAppearance>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is WeaponAppearance wpp)) return false;
