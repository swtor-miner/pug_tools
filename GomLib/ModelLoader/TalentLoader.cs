...
namespace GomLib.ModelLoader
{
    public class TalentLoader
    {
        ...
        private string TryGetString(string fqn, GomObjectData textRetriever)
        {
            ...
            try
            {
                strTable = _dom.stringTable.Find(locBucket);
            }
            catch
            {
                strTable = null;
        ...
        private string ReplaceTokens(string desc, int tokenIndex, string replacement) {
