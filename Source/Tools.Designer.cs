namespace PugTools
{
    partial class Tools
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chkBuildCompare.Text = "Compare Builds";
            ...
            this.chkRemoveElements.Text = "Remove Element";
            ...
            this.label7.Text = "Be careful what you put in here. As it will search and output all occurences in the GOM.";
            ...
            this.label6.Text = "Click and select what you want from the dialog window. The default is to dump everything.";
            // 
            // Tools
            // 
