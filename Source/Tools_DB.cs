...
namespace PugTools
{
    public partial class Tools
    {
        ...
        public static Dictionary<string, SQLInitStore> initTable = new Dictionary<string, SQLInitStore>
            {
                ...
                {"NewCompanions", new SQLInitStore("companion", new GomLib.Models.NewCompanion()) }
            };
        ...
        private string ToSQL(object obj)
        {
            ...
            {
                return @object.ToSQL(patchVersion);
            }
            else if (obj is GomLib.Models.PseudoGameObject object1)
            {
                return object1.ToSQL(patchVersion);
            }
    ...
    public class SQLInitStore
    {
        ...
        public SQLInitStore(string name, object obj)
        {
            ...
            if (obj is GomLib.Models.GameObject @object)
            {
                SqlData = @object.SQLInfo(); //not implemented yet
            }
            else if (obj is GomLib.Models.PseudoGameObject object1)
            {
