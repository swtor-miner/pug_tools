    ...
    public partial class TreeListView : VirtualObjectListView
    {
        ...
        public class Tree : IVirtualListDataSource, IFilterableDataSource
        {
            ...
            internal bool IsModelExpanded(object model)
            {
                ...
                if (model == null)
                    return true;
                this.mapObjectToExpanded.TryGetValue(model, out bool isExpanded);
                return isExpanded;
            }
            ...
            {
                if (model != null && this.mapObjectToIndex.TryGetValue(model, out int index))
                    return index;
                else
                    return -1;
            }
