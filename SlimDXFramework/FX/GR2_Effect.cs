...
namespace SlimDX_Framework.FX
{
    ...
    public class GR2_Effect : Effect
    {
        ...
        public EffectResourceVariable ShadowMap => _shadowMap;

        public EffectVectorVariable Palette1MetSpec => _palette1MetSpec;

        public EffectVectorVariable Palette2MetSpec => _palette2MetSpec;
